...
#ifdef __IPHONE_5_0
@property (nonatomic, strong) UIColor *tintColor UI_APPEARANCE_SELECTOR;  //刷新条的颜色
@property (nonatomic, assign) UIActivityIndicatorViewStyle activityIndicatorViewStyle  UI_APPEARANCE_SELECTOR; //下拉后网络菊花器的颜色
